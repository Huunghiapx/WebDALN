...
<head>
    ...
    <link href="{{ asset('build/vendor/datatables/dataTables.bootstrap4.min.css') }}" rel="stylesheet">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <!-- <a class="collapse-item" href="#">Đơn hàng chưa xử lý</a> -->
                    </div>
                </div>
            </li>
            <!-- Nav Item - Charts -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                        ...
                        @else
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    ...
                                    <img class="img-profile rounded-circle" src="{{ Auth::user()->image ? asset(Auth::user()->image) : asset('build/img/undraw_profile.svg') }}">
                                </a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    @yield('content')
                 <!-- Để nội dung trang con được chèn vào đây -->
                </div>
                <!-- /.container-fluid -->
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; PKA Shop 2024</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
