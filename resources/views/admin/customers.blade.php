...
<head>
    ...
    <link
        href="build/https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i"
        rel="stylesheet">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{ route('/home') }}">
                ...
                <div class="sidebar-brand-text mx-3">Admin PKA Shop<sup>2</sup></div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">QL Sản Phẩm:</h6>
                        <a class="collapse-item" href="{{ route('products') }}">Danh sách sản phẩm</a>
                        <a class="collapse-item" href="{{ route('products') }}">Danh mục sản phẩm</a>
                        <a class="collapse-item" href="{{ route('addproducts') }}">Thêm Sản phẩm</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('customers') }}">Danh sách khách hàng</a>
                        <a class="collapse-item" href="{{ route('addcustomers') }}">Thêm Khách Hàng</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Ql Đơn hàng:</h6>
                        <a class="collapse-item" href="{{ route('orders') }}">Danh sách đơn hàng</a>
                        <a class="collapse-item" href="{{ route('addorders') }}">">Thêm đơn hàng</a>
                    </div>
                </div>
            </li>
            <!-- Nav Item - Charts -->
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('') }}">Trang người dùng</a>
                    </div>
                </div>
            </li>
                    ...
                    @else
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <img class="img-profile rounded-circle" src="{{ Auth::user()->image ?: 'build/img/undraw_profile.svg' }}">
                            </a>
...
<div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="logoutModalLabel" aria-hidden="true">
    ...
    <!-- Page level plugins -->
    <script src="build/vendor/datatables/jquery.dataTables.min.js"></script>
    <script src="build/vendor/datatables/dataTables.bootstrap4.min.js"></script>
